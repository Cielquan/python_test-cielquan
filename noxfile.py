...
SPHINX_BUILDERS = ["html", "linkcheck", "coverage", "doctest"]
if "sphinxcontrib-confluencebuilder" in PYPROJECT["tool"]["poetry"]["extras"]["docs"]:
    SPHINX_BUILDERS.append("confluence")
